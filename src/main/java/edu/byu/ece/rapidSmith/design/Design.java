...
public class Design implements Serializable {
     ...
     */
    public Net getNet(String name) throws JGeneriloException {
        if (nets.containsKey(name))
            return nets.get(name);
        else {
            HashMap<String,Object> info = new HashMap<String, Object>();
            info.put("net_name",name);
            throw new JGeneriloException(JGeneriloExceptionType.NetNotExists, info);
        }
    }
    ...
    public void saveComparableXDLFile(String fileName) throws JGeneriloException {
        String nl = System.getProperty("line.separator");
        try {
            BufferedWriter bw = new BufferedWriter(new FileWriter(fileName));
