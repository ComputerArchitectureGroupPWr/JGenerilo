 ...
 */
public class Net implements Comparable<Net>, Serializable, Cloneable {
    ...
    public Object clone() throws CloneNotSupportedException {
        ...
        ArrayList<Pin> clonedPins = new ArrayList<Pin>();

        for (Pin pin : this.getPins())
            clonedPins.add(new Pin(pin.isOutPin(), pin.getName(), heaterInstances.get(pin.getInstanceName())));
        clone.setPins(clonedPins);

        return clone;
    }

    private HashMap<String, ThermalInstance> heaterInstances;

    public void setHeaterInstances(HashMap<String, ThermalInstance> heaterInstances) {
        this.heaterInstances = heaterInstances;
    }
