...
public class Device implements Serializable {
     ...
     */
    public static final String rapidSmithVersion = "0.5.0";
    /**
                            ...
                            for (WireConnection w : tile.getWireHashMap().get(wire)) {
                                if (w.getColumnOffset() != 0 || w.getRowOffset() != 0) {
                                    ...
                                    while (!tileStack.isEmpty() && watchDog < 100) {
                                        ...
                                        if (debug)
                                            System.out.println("  POP: " + t1 + " " + we.getWireName(w1.getWire()));
                                        ...
                                        for (WireConnection wire2 : connections) {
                                            if (setOfExternalPrimitivePins.contains(wire2.getWire())) {
                                                ...
                                                if (debug)
                                                    System.out.println("  FOUND: " + wire2.getTile(this, t1) + " " + we.getWireName(wire2.getWire()) + " xOffset=" + xOffset + " yOffset=" + yOffset);

                                                if (debug)
                                                    System.out.println("  SECOND: " + wire2.getTile(this, t1) + " " + we.getWireName(wire2.getWire()));
                                                ...
                                                if (debug)
                                                    System.out.println("  POTENTIAL: " + wire2.getTile(this, t1) + " " + we.getWireName(wire2.getWire()));
                                                if (!visited.contains(new Node(t1, w1.getWire(), null, 0))) {
                                                    tileStack.push(wire2.getTile(this, t1));
                                                    wireStack.push(wire2);
                                                }
