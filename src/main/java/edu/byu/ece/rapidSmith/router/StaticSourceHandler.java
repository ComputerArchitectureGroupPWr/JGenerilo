...
public class StaticSourceHandler {
    ...
    public void separateStaticSourceNets() {
            ...
            for (Tile t : switchMatrixSources.keySet()) {
                ...
                if (nets.size() > 0) {
                    ...
                    for (Net n : nets) {
                        ...
                        Node node = getSwitchBoxWire(n);
                        if (debug)
                            System.out.println("Debugging " + t.getName() + " net: " + n.getName() + " node: " + node.toString(we));
                        ...
                        if (wireName.startsWith("HALF")) {
                            if (wireName.contains("TOP")) {
                                ...
                                while (router.usedNodes.contains(newNode)) {
                                    if (debug)
                                        System.out.println("HALF Reserved Top " + reservedTop + " for " + v4TopOmuxs[reservedTop] + " net: " + n.getName() + " " + n.getSource().getName());
                                    reservedTop++;
                                    if (reservedTop > 7) {
                                        break;
                                    }
                                ...
                                while (router.usedNodes.contains(newNode)) {
                                    if (debug)
                                        System.out.println("HALF Reserved Bot " + reservedTop + " for " + v4BottomOmuxs[reservedBot] + " net: " + n.getName() + " " + n.getSource().getName());
                                    reservedBot++;
                                    if (reservedBot > 7) {
                                        break;
                                    }
                    ...
                    for (Net n : secondaryNets) {
                        ...
                        if (reservedTop < 8) {
                            ...
                            while (router.usedNodes.contains(newNode)) {
                                if (debug)
                                    System.out.println("SEC Reserved Top " + reservedTop + " for " + v4TopOmuxs[reservedTop] + " net: " + n.getName() + " " + n.getSource().getName());
                                reservedTop++;
                            ...
                            while (router.usedNodes.contains(newNode)) {
                                if (debug)
                                    System.out.println("SEC Reserved Bot " + reservedBot + " for " + v4BottomOmuxs[reservedBot] + " net: " + n.getName() + " " + n.getSource().getName());
                                reservedBot++;
                                if (reservedBot > 7) {
                                    break;
                                }
        ...
        if (dev.getFamilyType().equals(FamilyType.VIRTEX4)) {
            Node bounce0 = new Node();
            bounce0.wire = we.getWireEnum("BOUNCE0");
            Node bounce1 = new Node();
            bounce1.wire = we.getWireEnum("BOUNCE1");
            Node bounce2 = new Node();
            bounce2.wire = we.getWireEnum("BOUNCE2");
            Node bounce3 = new Node();
            bounce3.wire = we.getWireEnum("BOUNCE3");
        ...
        for (PinSorter ps : tileMap.values()) {
            ...
            if (ps.useSLICE.size() > 0) {
                ...
                if (gnds.size() > 0) {
                    ...
                    if (ps.useSLICE.get(0).node.tile.getName().equals("INT_X63Y158"))
                        System.out.println("SLICE: " + newNet.getName() + " " + we.getWireName(ps.useSLICE.get(0).node.getWire()) + " " + ps.useSLICE.get(0).pin.getName());
