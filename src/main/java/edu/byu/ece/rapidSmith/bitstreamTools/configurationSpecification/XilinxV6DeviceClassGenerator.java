 ...
 * for the virtex6 architecture.
 */
public class XilinxV6DeviceClassGenerator extends XilinxDeviceClassGenerator {
        ...
        for (String partName : _partNames) {
            ...
            try {
                ...
                for (Integer key : columnMap.keySet()) {
                    ...
                    if (subType == V6ConfigurationSpecification.BRAMINTERCONNECT) {
                        currBramContentLayout.add(V6ConfigurationSpecification.BRAMCONTENT);
                    }
                }

                currLogicLayout.add(V6ConfigurationSpecification.LOGIC_OVERHEAD);
                currBramContentLayout.add(V6ConfigurationSpecification.BRAMOVERHEAD);
    ...
    public static void main(String args[]) {
        XilinxV6DeviceClassGenerator gen = new XilinxV6DeviceClassGenerator();
