 ...
 *          Created on 13.05.14.
 */
public class ThermometerUnitDeserializer extends JsonDeserializer<ThermometerUnit> {
     ...
     */
    @Override
    public ThermometerUnit deserialize(JsonParser jp, DeserializationContext deserializationContext) throws IOException, JsonProcessingException {
