...
public class HeaterUnit extends ThermalUnit implements Cloneable {
    ...
    public HeaterUnit(String type, int CLBsize, int instanceNum) {
        super();
        this.type = type;
     ...
     */
    public HeaterUnit(String name, String type, int id, int col, int row) throws JGeneriloException {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof HeaterUnit)) return false;
        HeaterUnit heaterUnit = (HeaterUnit) obj;

        boolean isEqual = true;

        if (this.type != heaterUnit.type)
            isEqual = false;

        Iterator<ThermalInstance> thisIt = this.instances.iterator();
        Iterator<ThermalInstance> eqIt = heaterUnit.instances.iterator();
    ...
    public Object clone() throws CloneNotSupportedException {
        HeaterUnit clone = (HeaterUnit) super.clone();
